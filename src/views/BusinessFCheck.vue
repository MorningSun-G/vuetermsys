<template>
    <div>
        <el-row>
            ...
            <el-col :span="5">
                <el-select v-model="queryMap.deptno" style="width: 200px" placeholder="请选择部门" clearable>
        ...
        <el-table
            ...
            <el-table-column
                ...
                <template slot-scope="scope">
                    <el-tag v-if="scope.row.bstate == 3 " type="info" effect="dark">
                        待审批
                    </el-tag>
    ...
    export default {
        ...
        methods:{
            ...
            getBusiness(){
                ...
                this.$http.post("financeCheckBusiness",this.queryMap).then((res) =>{
            ...
            getDeptList(){
                this.$http.get("getAllDept").then(res =>{
                    for(var item of res.data){
                        if (item.dname != "管理员" && item.dname != "财务"){
